...
namespace MESForm.Han
{
    public partial class popupOrder : BaseForms.frmPopup
    {
        ...
        private void DGVSetting()
        {
            ...
            CommonUtil.AddGridTextColumn(dgvOrder, "수량", "Mtp_Amount", 80, false);
            ...
            CommonUtil.AddGridTextColumn(dgvReOrder, "수량", "Mtp_Amount");
            CommonUtil.AddGridTextColumn(dgvReOrder, "업체코드", "Com_Code");
            CommonUtil.AddGridTextColumn(dgvReOrder, "잔량", "Mtp_Amount");
            CommonUtil.AddGridTextColumn(dgvReOrder, "취소가능량", "Mtp_Amount");
